...
a4s1  = 27 # 4s orbital of fake-Argon
e4s1 = orb_energy[a4s1]

a3p1 = [18,19,20] # 3p orbitals of fake Argon

#a4s2  = 20 # 4s orbital of Argon
#e4s2 = orb_energy[a4s2]

a3p2 = [24,25,26] # 3p orbitals of Argon

virt = [ i  for i in  range(30,99)] # virtual (continuum) orbitals
